...
| Guardrails | **Stubbed** | One rule lives in the Resolution Agent's prompt (escalate if policy confidence is low or amount > $200) rather than a full input-filter/output-check/circuit-breaker stack |
